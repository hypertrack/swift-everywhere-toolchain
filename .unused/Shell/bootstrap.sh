...
SA_CMD="apt-get -y install mc git-lfs ruby clang python autoconf libtool uuid-dev libicu-dev icu-devtools libbsd-dev libedit-dev libxml2-dev libsqlite3-dev swig libpython-dev libncurses5-dev pkg-config libblocksruntime-dev systemtap-sdt-dev tzdata rsync"
echo "Executing command: \"$SA_CMD\""
echo "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
$SA_CMD
